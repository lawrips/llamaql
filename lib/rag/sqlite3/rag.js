...
class Rag {
    ...
    async query(userQuery, annotation, model, instructions, schema, requery) {
        ...
        if (!requery) {
            ...
            response = await this.#requeryWorkflow(userQuery, annotation, queries, requery, model || defaultModel, instructions, schema);
        }
        return response;
    }
    ...
    async #requeryWorkflow(naturalLanguageQuery, annotation, queries, query, model, instructions, schema, previousEx) {
        ...
        if (!previousEx) {
            let dbQuery = await this.#retryQuery(naturalLanguageQuery, annotation, queries, query, model, instructions, schema, previousEx);
    ...
    async #retryQuery(naturalLanguageQuery, annotation, queries, query, model, instructions, schema, ex) {
