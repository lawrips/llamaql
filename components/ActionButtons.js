...
const ActionButtons = ({ handleSaveQuery, handleSaveData, handleChat, handleChatReturn, handleExportJsonl, handleImportJsonl, fileInputRef, handleFileChange, handleFinetune, shared, isCreateModalOpen, isDeleteModalOpen, handleCreateTable, handleDeleteTable, handleCancelTable, handleOpenCreateDialog, handleOpenDeleteDialog, createTableCount }) => {
        ...
        </button>
        {
          !shared && (session.user?.role == 'editor' || session.user?.role == 'admin') ?
            <>
              ...
              <Table className="mr-2 h-4 w-4" />Create Table</button>
