export const fetchInitialOptions = async (appName) => {
    const res = await fetch(`/api/protected/load-setup?app=${appName}`, {
      method: 'GET',
  ...
  export const executeNLQuery = async(model, appName, query, annotation, instructions, dataSchema, requery) => {
    const res = await fetch(`/api/protected/query?model=${model}&app=${appName}`, {
      method: 'POST',
      headers: {'Content-Type': 'application/json'},
  ...
  export const executeDirectQuery = async (model, appName, query) => {
    const res = await fetch(`/api/protected/execute?model=${model}&app=${appName}`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  export const translateQueryResult = async (model, appName, query, annotation, input, instructions) => {
    const res = await fetch(`/api/protected/translate?model=${model}&app=${appName}`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
