        ...
        if (provider == 'openai') {
            ...
            const formattedResponse = await openai.chat.completions.create({
                ...
                messages: [
                    {
                        role: "system",
                        content: `Format this MongoDB result into a natural language response (use lists when appropriate but DO NOT include any markdown whatsover in the response such as ** Name **)`
                    },
                    {
                        role: 'user',
